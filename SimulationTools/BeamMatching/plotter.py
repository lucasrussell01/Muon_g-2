...
def plot(mismatch, var, var_name, n, nion, x, y, xp, yp, default):
    ...
    #ax[0][0].set_ylim(0, 2)
    ax[0][0].axvline(default, 0, 1, color = "red", linestyle="--")
    ...
    ax[0][1].axvline(default, 0, 1, color = "red", linestyle="--")
    ...
    ax[0][2].axvline(default, 0, 1, color = "red", linestyle="--")
    ...
    ax[1][0].axvline(default, 0, 1, color = "red", linestyle="--")
    ...
    ax[1][1].axvline(default, 0, 1, color = "red", linestyle="--")
    ...
    ax[1][2].axvline(default, 0, 1, color = "red", linestyle="--")
