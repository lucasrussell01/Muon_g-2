...
plot(matches, var, "z position (m)", n_hit, n_ion, x, y, xp, yp, 3.3e-3) 


var, matches, n_hit, n_ion, x, y, xp, yp = vary_y_pos()
plot(matches, var, "y position (m)", n_hit, n_ion, x, y, xp, yp, 0) 

var, matches, n_hit, n_ion, x, y, xp, yp = vary_z_size()
plot(matches, var, "z beam size (m)", n_hit, n_ion, x, y, xp, yp, 2.3e-3) 

var, matches, n_hit, n_ion, x, y, xp, yp = vary_y_size()
plot(matches, var, "y beam size (m)", n_hit, n_ion, x, y, xp, yp, 23e-3) 
